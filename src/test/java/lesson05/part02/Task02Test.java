...
public class Task02Test {
    private static String fileName = "./src/main/java/lesson05/part02/Task02.java";
    String s[];
    String r;
    int startLineMain;
    ...
    public void t1(){/*впишите свои числа */
        Assert.assertTrue("Не пройдено 1 условие",r.equals("\r\n"));
    ...
    public void t3(){/*впишите свои числа */
        Method[] a=Task02.Whale.class.getDeclaredMethods();
        boolean w=false;
        for (Method c:a
    ...
    public void t56(){/*впишите свои числа */
        ...
        Task02.Whale a=new Task02.Whale();
        Assert.assertTrue(   "Не пройдено 56 test",r.contains(a.getName()) && r.equals("\r\n"));
    }
