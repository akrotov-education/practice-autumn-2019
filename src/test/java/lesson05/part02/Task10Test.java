...
public class Task10Test {
    private static String fileName = "./src/main/java/lesson05/part02/Task10.java";
    String s[];
    String r;
    int l1=0;
    ...
    public void t3() throws NoSuchMethodException {/*впишите свои числа */
        Method a=Task10.class.getMethod("max",int.class,int.class);
    ...
    public void t4() throws NoSuchMethodException {/*впишите свои числа */
        ...
        Assert.assertTrue(   "Не пройдено 4 условие",Task10.max(1,8)==8);
    }
    @Test
    public void t5() throws NoSuchMethodException {/*впишите свои числа */
        Method a=Task10.class.getMethod("max",long.class,long.class);
    ...
    public void t6() throws NoSuchMethodException {/*впишите свои числа */
        ...
        Assert.assertTrue(   "Не пройдено 6 условие",Task10.max(1L,8L)==8L);
    }
    @Test
    public void t7() throws NoSuchMethodException {/*впишите свои числа */
        Method a=Task10.class.getMethod("max",double.class,double.class);
    ...
    public void t8() throws NoSuchMethodException {/*впишите свои числа */
        ...
        Assert.assertTrue(   "Не пройдено 8 условие",Task10.max(1D,8D)==8D);
    }
}