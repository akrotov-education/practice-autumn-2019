...
public class Task01Test {
    ...
    public void task01ifListIntCreated() {
        ...
        for (String s : collect) {
            if (s.contains("int[] list") && s.contains("= new int[20]"))
                isListCreated = true;
        }
    ...
    public void task01KeyboardInputToList() {
        ...
        for (String s : collect) {
            if (s.contains("list[i] = Integer.parseInt")) {
                isInputExist = true;
                break;
            }
        }
    ...
    public boolean checkCode(String funcName) {
        ...
        test = collect.get(a).equals("  public static void " + funcName + "(String[] args) throws Exception {") &&
