...
public class Task42Test {
    private static String fileName = "./src/main/java/lesson04/part03/Task42.java";
    int startLineMain;
    ...
    public void checkSout(){
        Assert.assertTrue("",r.contains("java.lang.IndexOutOfBoundsException: Index 18 out of bounds for length 0"));
    }
    ...
    public void checkMainNotDelCode(){
        ...
        for (String s:listMain
            ...
            if(s.contains("ArrayList<String> list = new ArrayList<String>();")) a=true;
            if(s.contains("String s = list.get(18);")) b=true;
        }
