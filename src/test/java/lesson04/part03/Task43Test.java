...
public class Task43Test {
    ...
    private static String fileName = "./src/main/java/lesson04/part03/Task43.java";
    int startLineMain;
    ...
    public void checkMainNotDelCode(){
        ...
        for (String s:listMain
            ...
            if(s.contains("HashMap<String, String> map = new HashMap<String, String>(null);")) a=true;
            if(s.contains("map.put(null, null);")) b=true;
            if(s.contains("map.remove(null);")) c=true;
        }
        Assert.assertTrue("don't delete rows in main",a&&b&&c);
    }
