...
public class Task37Test {
    private static String fileName = "./src/main/java/lesson04/part03/Task37.java";
    private static String returnString="return Thread.currentThread().getStackTrace()[2].getLineNumber();";
    int startLineMain;
    ...
    public void before() throws Exception {
        try (Stream<String> stream = Files.lines(Paths.get(fileName))) {
            ...
            for (int i=0;i<collect.size();i++
                ...
                if(collect.get(i).contains("static int method1()")) startLineMethod1=i;
                if(collect.get(i).contains("static int method2()")) startLineMethod2=i;
                if(collect.get(i).contains("static int method3()")) startLineMethod3=i;
                if(collect.get(i).contains("static int method4()")) startLineMethod4=i;
                if(collect.get(i).contains("static int method5()")) startLineMethod5=i;
    ...
    public void Check5metods(){
        Method a[]=Task37.class.getMethods();
        int m=0;
        for (Method s:a
             ) {
            if(s.toString().contains("lesson04.part03.Task37"))m++;
        }
    ...
    public void CheckReturnStack(){
        ...
        assertEquals("return value error", 5, m);
    }
}