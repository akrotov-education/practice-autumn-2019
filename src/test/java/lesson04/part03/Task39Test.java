...
public class Task39Test {
    private static String fileName = "./src/main/java/lesson04/part03/Task39.java";
    int startLineMain;
    ...
    public void checkMainNotDelCode(){
        ...
        for (String s:listMain
            ...
            if(s.contains("int a = 42 / 0;")) a=true;
        }
        Assert.assertTrue("don't delete row int a = 42 / 0;",a);
    }
