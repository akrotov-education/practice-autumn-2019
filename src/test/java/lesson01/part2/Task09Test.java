...
public class Task09Test {
    ...
    public void test09CheckMain() {
        Assert.assertTrue("Не пройдено 5е условие!",collect.get(18).contains("= new Woman();") &&
                collect.get(19).contains("= new Cat();") &&
                collect.get(20).contains(".owner = ") &&
                collect.get(25).contains("new Fish();") &&
                collect.get(26).contains(".owner = ") &&
                collect.get(22).contains("new Dog();") &&
