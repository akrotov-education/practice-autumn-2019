...
public class Task09Test {
    ...
    public void test09CheckMain() {
        ...
        Assert.assertTrue("Не пройдено 5е условие!",collect.get(19).contains("=new Woman();") &&
                collect.get(20).contains("=new Cat();") &&
                collect.get(21).contains(".owner=") &&
                collect.get(22).contains("new Fish();") &&
                collect.get(23).contains(".owner=") &&
                collect.get(24).contains("new Dog();") &&
                collect.get(25).contains(".owner=") );
    }
