...
public class Task10Test {
    ...
    public void test11_3() {
        ...
        Assert.assertTrue("Не пройдено 3е условие!", collect.get(26).contains("min(") &&
    ...
    public void test11_4() {
        ...
        Assert.assertTrue("Не пройдено 4е условие!", collect.get(25).contains("System.out.println(min") &&
