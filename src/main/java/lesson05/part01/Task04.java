 ...
 * <p>
 * Требования:
 * 1. В классе задачи должен быть public класс Employee (сотрудник).
 * 2. В классе задачи должен быть public класс Manager (управляющий).
 * 3. В классе задачи должен быть public класс Chief (директор).
 * 4. В классе задачи должен быть public класс Secretary (секретарь).
