 ...
 * <p>
 * Требования:
 * 1. В классе задачи должен быть public класс Judaism (Иудаизм).
 * 2. В классе задачи должен быть public класс Christianity (Христианство).
 * 3. В классе задачи должен быть public класс Islam (Мусульманство).
