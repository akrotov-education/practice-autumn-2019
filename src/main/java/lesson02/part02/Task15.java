...
public class Task15 {
    public static void main(String[] args) throws Exception {
        ...
        int num2 = s.nextInt();
        int num3 = s.nextInt();
        if (num1 + num2 < num3) System.out.println("Треугольник не существует.");
        else if (num2 + num3 < num1) System.out.println("Треугольник не существует.");
        else if (num1 + num3 < num2) System.out.println("Треугольник не существует.");
