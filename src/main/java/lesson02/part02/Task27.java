...
public class Task27 {
    public static void main(String[] args) throws Exception {
        ...
        if (a>=1 && a<10 && a%2==0) System.out.println("четное однозначное число");
        if (a>=1 && a<10 && a%2!=0) System.out.println("нечетное однозначное число");
        if (a>=10 && a<100 && a%2==0) System.out.println("четное двузначное число");
        if (a>=10 && a<100 && a%2!=0) System.out.println("нечетное двузначное число");
