...
public class Task07 {
    public static void main(String[] args) {
        ...
        protoss1.name = "Eldar1";
        protoss2.name = "Eldar2";
        protoss3.name = "Eldar3";

        Terran terran1 = new Terran();
        Terran terran2 = new Terran();
        Terran terran3 = new Terran();
        Terran terran4 = new Terran();
        terran1.name = "SpaceMarine1";
        terran2.name = "SpaceMarine2";
        terran3.name = "SpaceMarine3";
        terran4.name = "SpaceMarine4";
