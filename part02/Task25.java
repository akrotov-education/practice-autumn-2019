...
public class Task25 {
    ...
    public static String getObjectType(Object o) {
        ...
        if (className.contains("Cat")) { return "Кот"; }
        if (className.contains("Tiger")) { return "Тигр"; }
        if (className.contains("Lion")) { return "Лев"; }
        if (className.contains("Bull")) { return "Бык"; }
        if (className.contains("Cow")) { return "Корова"; }
        return "Животное";
    }
