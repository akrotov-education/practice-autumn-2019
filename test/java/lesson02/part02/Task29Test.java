...
public class Task29Test {
    ...
    @Test
    public void PositiveCountOutput() throws Exception {
    ...
    @Test
    public void NegativeCountOutput() throws Exception {
        SystemInGatewayUtil.provideInput("0\n1\n2\n");
        Task29.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
    ...
    @Test
    public void NegativeCountShouldBeDisplayed() throws Exception {
    ...
    @Test
    public void PositiveCountShouldBeDisplayed() throws Exception {
        SystemInGatewayUtil.provideInput("-1\n-2\n-3\n");
        Task29.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
    ...
    @Test
    public void ZeroMustBeCountedAsZero() throws Exception {
        SystemInGatewayUtil.provideInput("0\n0\n0\n");
        Task29.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
