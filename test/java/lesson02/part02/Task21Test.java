...
public class Task21Test {
    private static String fileName = "C:\\Users\\1\\Desktop\\7сем\\java\\practice-autumn-2019-master\\practice-autumn-2019-master\\src\\main\\java\\lesson02\\part02\\Task21.java";
    ...
    @Test
    public void task21ifTwoLinesAreRead() throws Exception {
        int readerCount = 0;
        try (Stream<String> stream = Files.lines(Paths.get(fileName))) {
            List<String> collect = stream.collect(Collectors.toList());
            for (String s : collect) {
                if (s.contains("readLine()") || s.contains("nextLine()") || s.contains("in.next"))
                    readerCount++;
            }
