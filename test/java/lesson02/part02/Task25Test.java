...
public class Task25Test {
    ...
    @Test
    public void correct1stQuarter() throws Exception {
    ...
    @Test
    public void correct2ndQuarter() throws Exception {
        SystemInGatewayUtil.provideInput("-1\n1\n");
        Task25.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
    ...
    @Test
    public void correct3rdQuarter() throws Exception {
        SystemInGatewayUtil.provideInput("-1\n-1\n");
        Task25.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
    ...
    @Test
    public void correct4thQuarter() throws Exception {
        SystemInGatewayUtil.provideInput("1\n-1\n");
        Task25.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
