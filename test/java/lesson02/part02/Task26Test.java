...
public class Task26Test {
    ...
    @Test
    public void isNegativeEven() throws Exception {
    ...
    @Test
    public void isNegativeOdd() throws Exception {
    ...
    @Test
    public void isPositiveEven() throws Exception {
        SystemInGatewayUtil.provideInput("10\n");
        Task26.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
        String result = stream.toString();
    ...
    @Test
    public void isPositiveOdd() throws Exception {
