...
public class Task28Test {
    ...
    @Test
    public void isResultCorrect() throws Exception {
    ...
    @Test
    public void ifOutputCorrectWithNoPositiveInt() throws Exception {
        int[] nums = {-1,-2,0};
        SystemInGatewayUtil.provideInput("-1\n-2\n0\n");
        Task28.main(null);
        ByteArrayOutputStream stream = SystemOutGatewayUtil.getOutputArray();
    ...
    @Test
    public void ifZeroIsntCounted() throws Exception {
