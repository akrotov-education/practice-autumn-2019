...
public class Task12Test {
    ...
    public void checkPositive() {
        ...
        Assert.assertEquals("The program should display a value twice as large", "4", outLines[0]);
    }
    ...
    public void checkNegative() {
        ...
        Assert.assertEquals("The program should display a value 1 more", "-1", outLines[0]);
    }
    ...
    public void checkZero() {
        ...
        Assert.assertEquals("The program should display zero", "0", outLines[0]);
    }
}