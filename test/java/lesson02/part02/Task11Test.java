...
public class Task11Test {
    public static String fileName = "./src/main/java/lesson02/part02/Task11.java";
    ...
    public void checkFuncCheckSeason() {
        try {
            ...
            Assert.assertTrue("Method checkSeason must be static", modifier.contains("static"));
            Assert.assertEquals("Method checkSeason must have void return type", "void", type);
    ...
    public void checkFuncCheckSeasonWork() {
        ...
        Assert.assertEquals("Method checkSeason works incorrect", "зима", outLines[0]);
        Assert.assertEquals("Method checkSeason works incorrect", "весна", outLines[1]);
        Assert.assertEquals("Method checkSeason works incorrect", "лето", outLines[2]);
        Assert.assertEquals("Method checkSeason works incorrect", "осень", outLines[3]);
    }
}
