...
public class Task44Test {
    private static String fileName = "./src/main/java/lesson04/part03/Task44.java";
    int startLineMain;
    ...
    public void checkSout(){
        Assert.assertTrue("",r.contains("java.lang.NumberFormatException: For input string: \"XYZ\""));
    }
    ...
    public void checkMainNotDelCode(){
        ...
        for (String s:listMain
            ...
            if(s.contains("int num = Integer.parseInt(\"XYZ\");")) a=true;
            if(s.contains("System.out.println(num);")) b=true;
        }
