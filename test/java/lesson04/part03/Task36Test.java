...
public class Task36Test {
    ...
    public void before() throws Exception {
        try (Stream<String> stream = Files.lines(Paths.get(fileName))) {
            ...
            for (int i=0;i<collect.size();i++
                ...
                if(collect.get(i).contains("static String method1()")) startLineMethod1=i;
                if(collect.get(i).contains("static String method2()")) startLineMethod2=i;
                if(collect.get(i).contains("static String method3()")) startLineMethod3=i;
                if(collect.get(i).contains("static String method4()")) startLineMethod4=i;
                if(collect.get(i).contains("static String method5()")) startLineMethod5=i;
    ...
    public void Check5metods(){
        Method a[]=Task36.class.getMethods();
        int m=0;
        for (Method s:a
        ) {
            if(s.toString().contains("lesson04.part03.Task36"))m++;
        }
    ...
    public void CheckCallMethod(){
        ...
        Assert.assertTrue("method call error",m==5);
    }
