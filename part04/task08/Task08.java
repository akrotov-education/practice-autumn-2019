package lesson05.part04.task08;
...
public class Task08 {
    public static void main (String[] args) {
        println(new lesson05.part04.task08.WaterBridge());
        println(new lesson05.part04.task08.SuspensionBridge());
    }

    public static void println(lesson05.part04.task08.Bridge bridge){
