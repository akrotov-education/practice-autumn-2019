...
import lesson05.part04.task16.Hrivna;
import lesson05.part04.task16.Ruble;
import lesson05.part04.task16.USD;
 ...
 * 2. В классе Money должен быть реализован публичный конструктор с одним параметром типа double, который устанавливает значение переменной
 * amount согласно переданному параметру.
 ...
 * 7. В классах Hrivna, Ruble и USD должен быть реализован публичный конструктор с одним параметром типа double, который устанавливает значение
